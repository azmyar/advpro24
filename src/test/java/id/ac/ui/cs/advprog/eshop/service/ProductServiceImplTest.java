...
class ProductServiceImplTest {
    ...
    void testFindById() {
        ...
        product.setProductName("Sampo Cap Bambang");
        product.setProductQuantity(100);
        Mockito.when(productRepository.getProductById("eb558e9f-1c39-460e-8860-71af6af63bd6")).thenReturn(product);

        assertEquals(product, productService.getProductById("eb558e9f-1c39-460e-8860-71af6af63bd6"));
    }
