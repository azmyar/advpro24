...
class PaymentServiceTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("13652556-012a-4c07-b546-54eb1396d79b", products,
                1708560000L, "Tatang Ancis");
        orders.add(order1);
        Order order2 = new Order("7f9e15bb-4b15-42f4-aebc-c3af385fb078", products,
                1708570000L, "Tatang Buncis");
        orders.add(order2);

        payments = new ArrayList<>();

        Map<String, String> paymentData1 = new HashMap<>();
        paymentData1.put("voucherCode", "ESHOP1234ABCDEFG");
    ...
    void testSetStatusInvalidStatus() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            Payment result = paymentService.setStatus(newPayment, "ANOTHER_PAYMENT");
        });
    }
    ...
    void testFindByIdIfIdNotFound() {
        doReturn(null).when(paymentRepository).findById("id_ancis");
        assertNull(paymentService.getPayment("id_ancis"));
    }
